...
if ($_SERVER["REQUEST_METHOD"] === 'POST') 
{
    ...
    try {            
        ...
        //Salvando o caminho e retirando o "../"   
        $caminho = substr(upload("../uploads/foto-perfil", $_FILES['foto-perfil']),3);
        ...
        {    
            ...
            if ($rows <= 0) 
            {
                $stmt = $pdo->prepare("insert into TCC_cliente (CPF, nome, email, senha, dataNascimento, fotoPerfil) values (:CPF, :nome, :email, :senha, :dataNascimento, :fotoPerfil)");
                ...
                $stmt->bindParam(':fotoPerfil',$caminho);
